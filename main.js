...
.then(data => {
    ...
    Discos.forEach(Disco => {
        ...
        canciones.addEventListener("click", function () {
            ...
            Disco.canciones.forEach(cancion => {
                const cancionElement = crearBotonesVotacion(cancion);
    ...
    function crearBotonesVotacion(cancion) {
        ...
        quitarVoto.addEventListener("click", function () {
            ...
            if (sacarvotosCancion > 0) {
                Swal.fire({
                    icon: "warning",
                    title: "",
                    text: `Su voto a ${cancion.nombre} ha sido eliminado`,
                });
            } else {
                Swal.fire({
                    icon: "error",
                    title: "",
                    text: `La canción ${cancion.nombre} no tiene votos`,
                });
            }
        });
